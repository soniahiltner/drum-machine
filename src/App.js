...
function App() {
  ...
  const setkeyvolume = (val) => {
    const audios = val.map(sound => document.getElementById(sound.keytrigger));
  ...
  return (
    ...
    <div  className='container drum-machine' style={pianoshown ? {backgroundColor: 'rgb(0, 43, 43)'} : {backgroundColor: 'rgb(182, 43, 43)'}}>
      ...
      {drumshown && (
        ...
        <button className='sounds_button' onClick={handleSet}>Sounds kits</button>
      </div>
